                        ...
                        <Item sx={{ textAlign: 'left', boxShadow: 0 }}>
                            {ticket && (
                                <Typography fontSize={13}>
                                    ...
                                    <br />
                                    {t('editTicket.client_email')}:{' '}
                                    {ticket?.client_email}
                                    <br />
                                    {t('editTicket.client_name')} :{' '}
                                    {ticket?.client_name}
                                    <br />
                                    <br />
                                    {t('editTicket.first_payment')}:{' '}
                                    {ticket.paid}
                                    <br />
                        ...
                        render={({ field }) => {
                            return (
                                <TextField
                                    ...
                                    helperText={
                                        errors.last_part_payment?.message
                                    }
                                />
                            );
                        }}
